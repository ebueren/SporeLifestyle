...
dan.tax <- read.csv(here("00_data", "01_desc", "metadata", "GTDB", "original_metadata", "Schwartz_gtdb_families_sporulation.csv"))
dan.tax$gtdb_f<- gsub('f__', '', dan.tax$gtdb_f) 

### load recent gtdb tax table
gtdb.tax <- read.csv(here("00_data", "01_desc", "metadata", "GTDB", "original_metadata", "gtdb-taxonomy-table.csv" ))
...
write.csv(tax, (here("00_data", "01_desc", "metadata", "GTDB", "GTDBFamilySporulation.csv")))
```
